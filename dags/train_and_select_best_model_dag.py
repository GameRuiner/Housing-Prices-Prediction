...
with DAG(
  ...
  train_reduced_model_op = PythonOperator(
    task_id='train_reduced_model',
    python_callable=train_reduced_model
  )

  train_mean_model_op = PythonOperator(
    task_id='train_mean_model',
    python_callable=train_mean_model
  )
  
  train_median_model_op = PythonOperator(
    task_id='train_median_model',
    python_callable=train_median_model
  )

  select_best_model_op = PythonOperator(
